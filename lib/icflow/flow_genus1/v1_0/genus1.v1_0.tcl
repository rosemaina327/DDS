...
puts "Loaded Package from $genus1Folder"
...
icDefineParameter IC_GENERATE_SV_WRAPPER "Request SV Wrapper generation (for designs using SV interfaces at the top level)" 1
...
icDefineParameter IC_POWEREFFORT "General Power Effort configuration"           high

icDefineParameter IC_SYN_EFFORT "Set the effort for Synthesis" high
icDefineParameter IC_SYN_OPT_EFFORT "Set the effort for post-mapping opt" extreme
...
icDefineStep synthesize  "The main Synthesis step."
...
icApply mmmc {
    ...
    read_physical -lefs $::IC_LEF_FILES
...
icApply finish {
    ...
    write_hdl  > netlist/${::IC_TOP}.gtl.v
    write_hdl  > $reportFolder/${::IC_TOP}.gtl.v

    if {${::IC_GENERATE_SV_WRAPPER}==1} {
        catch {write_sv_wrapper  -wrapper_name ${::IC_TOP}_W  -exclude_type_definition  $::IC_TOP > netlist/${::IC_TOP}.gtl.sv}
    }
