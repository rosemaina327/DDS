...
# Negedge version
#set_input_delay  -max -clock ftdi_clk 7.0 [get_ports ftdi_data* ]
#set_input_delay  -max -clock ftdi_clk 1.0 [get_ports ftdi_rxf_n ]
#set_input_delay  -max -clock ftdi_clk 1.0 [get_ports ftdi_txe_n ]

#set_output_delay  -max -clock ftdi_clk 4.0 [get_ports ftdi_data* ] -clock_fall
#set_output_delay  -max -clock ftdi_clk 5.0 [get_ports ftdi_oe_n ] -clock_fall
#set_output_delay  -max -clock ftdi_clk 5.0 [get_ports ftdi_rd_n ] -clock_fall
#set_output_delay  -max -clock ftdi_clk 5.0 [get_ports ftdi_wr_n ] -clock_fall
...
set_output_delay -max -clock  async_io_dummy_clk 1.0 [get_ports led* ]
set_output_delay -min -clock  async_io_dummy_clk .5 [get_ports led* ]

set_input_delay -max  -clock async_io_dummy_clk 1.0  [get_ports cpu_resetn ]
set_input_delay -min -clock  async_io_dummy_clk .5  [get_ports cpu_resetn ]
